...
import { computePreviousRootCID, PeakWithHeight } from "./computePreviousRootCID.ts"
...
import { encodeLinkNode } from "../shared/codec.ts"
...
export class AccumulatorClient {
   ...
   */
  async findLatestAvailableRootCidOnIpfs(ipfsClient: any, options?: {
    jumpStep?: number,
    minStep?: number,
    maxSearch?: number,
